...
If your FPGA is not already programmed with the Vollo accelerator or the Vollo Trees accelerator then please
...
If the FPGA card already has a Vollo Accelerator Bitstream or a Vollo Trees accelerator bitstream, it can be updated
